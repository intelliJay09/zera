      ...
      <section className="relative min-h-[70vh] flex items-center justify-center px-6 py-32 bg-near-black border-b border-copper-500/10">
        ...
        >
          ...
          >
            ...
            >
              <Link href="/growth-audit" data-gtm-event="cta_book_strategy" data-gtm-location="product_market_monopoly_hero">Book Your Systems Audit</Link>
            </Button>
          </motion.div>
        </motion.div>
      </section>
      ...
      <section className="py-24 px-6 bg-near-black border-t border-copper-500/20">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              <Link href="/growth-audit" data-gtm-event="cta_book_strategy" data-gtm-location="product_market_monopoly_cta">Book Your Systems Audit</Link>
            </Button>
            <Button
              asChild
              variant="secondary"
