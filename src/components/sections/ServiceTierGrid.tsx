              ...
              <div className="relative h-full bg-gradient-to-br from-near-black via-near-black/95 to-near-black/90 rounded-none p-6 sm:p-10 md:p-12 lg:p-14 transition-all duration-700 ease-out hover:shadow-2xl hover:scale-[1.02] hover:-translate-y-2 overflow-hidden">
                ...
                <div className="relative z-10 h-full flex flex-col">
                  ...
                  <Link
                    ...
                    className="inline-flex items-center justify-center gap-2 px-4 py-3.5 bg-copper-600 text-cream-50 hover:bg-copper-700 font-medium text-xs sm:text-sm tracking-normal transition-all duration-300 group/btn mt-auto uppercase w-full whitespace-nowrap"
                  >
