...
const phases = [
  ...
  },
  {
    ...
    subtitle: '',
    description:
      'We execute the build. Whether it is a Digital HQ or a Velocity System, we deploy within your agreed project timeline - systematically and on schedule.',
    icon: Cog,
  },
  {
    number: 4,
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-[1400px] relative">
        ...
        >
          <Button asChild variant="primary" size="lg" className="group">
            <Link href="/systems-audit" data-gtm-event="cta_book_strategy" data-gtm-location="engagement_protocol">
              SECURE SYSTEMS AUDIT
