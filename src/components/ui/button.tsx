...
const buttonVariants = cva(
  'inline-flex items-center justify-center font-medium text-base transition-all duration-300 ease-out disabled:pointer-events-none disabled:opacity-50 w-fit rounded-none',
  {
    variants: {
      variant: {
        primary:
          'bg-copper-500 text-white shadow-lg shadow-copper-500/10 hover:bg-copper-600 hover:scale-[1.02] hover:shadow-2xl hover:shadow-copper-500/25 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-copper-500 focus-visible:ring-offset-4',
        secondary:
      ...
      size: {
        default: 'px-10 py-4 min-h-[52px]',
        sm: 'px-8 py-3.5 min-h-[44px]',
        lg: 'px-12 py-5 min-h-[56px]',
      },
    },
    defaultVariants: {
      variant: 'primary',
