...
const socialLinks = [
  {
    name: 'Instagram',
    href: 'https://www.instagram.com/zera.systems/',
    icon: (
  ...
  {
    name: 'LinkedIn',
    href: 'https://linkedin.com/company/zerahq',
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div className="flex gap-4 pt-2">
              {socialLinks.map((social) => (
                <a
                  key={social.name}
                  href={social.href}
                  className="p-2 -m-2 text-gray-900 transition-colors hover:text-copper-600"
                  target="_blank"
            ...
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.name}>
                  <Link
                    href={link.href}
                    className="text-sm text-gray-600 transition-colors hover:text-copper-600 uppercase"
                  >
                    {link.name}
                  </Link>
                </li>
            ...
            <ul className="space-y-3 text-sm text-gray-600">
              <li>
                <strong className="text-copper-700 font-semibold">
                  Accra, Ghana (Global HQ)
                </strong>
              </li>
              <li>
                <a
                  href="mailto:hello@zerahq.com"
                  className="hover:text-copper-600 transition-colors duration-300"
                >
                  hello@zerahq.com
                </a>
              </li>
